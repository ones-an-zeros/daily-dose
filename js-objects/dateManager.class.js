Date.prototype.addDays =function(s){
  ...
  var thisYear = parseInt(this.getUTCFullYear())
  var thisDays = parseInt(this.getUTCDate())
  var thisMonth = parseInt(this.getUTCMonth() + 1)
  ...
  if( targetDays < 0) {
    ...
    this.setTime(t)
    var thisDate = new Date(currYear,currMonth - 1,this.getUTCDate())
    return thisDate;
